...
#### 技术改进
- ✅ 扩展回调接口，新增 `on_paper_removed`、`on_paper_ready_for_confirmation`、`get_confirmed_abstract` 等回调
- ✅ 优化实时确认流程，支持单篇论文的独立确认
- ✅ 改进状态管理，支持更细粒度的状态更新和显示
